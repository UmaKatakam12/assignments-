...
public class WithoutMethodsInTesting {
	...
	//Test Case 1: Validating the Home Page
			...
			System.out.println("==============Test Case 3: Validating the Login Page with Valid Credentials==================");
			System.out.println("Launch the chrome browser");
			System.out.println("Enter url 'www.icici.com' and launch application");
			System.out.println("Enter username as Bharath");
			System.out.println("Enter password as bharath123");
			...
			System.out.println("==============Test Case 3: Validating the Login Page with Invalid Credentials==================");
			System.out.println("Launch the chrome browser");
			System.out.println("Enter url 'www.icici.com' and launch application");
