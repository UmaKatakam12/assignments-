...
public class Assignment4_Collections {
	...
	public static void main(String[] args) {
		...
		// Student1Map details in Map(HashMap) 
		...
		// Student2Map details in Map(HashMap) 
		...
		// Student3Map details in Map(HashMap) 
		...
		//Student1Map,Student2Map,Student3Map details in List (studentList)
		...
		// Employee1Map details in Map(HashMap) 
		...
		// Employee2Map in using Map(HashMap) 
		...
		// Employee3Map in using Map(HashMap) 
		...
		// Product1Map details in Map(HashMap) 
		...
		// Product2Map details in Map(HashMap) 
		...
		// Product3Map details in Map(HashMap) 
		...
		//Product1Map,Product1Map,Product1Map details in List (productList)
		...
		//studentList,empList,productList are mapped under Map(HashMap)
