...
public class Assignment2_3DArray {
	...
	public static void main(String[] args) {
		...
		// 3D Array: [Semester][Subject/Marks][Values]
				...
				//  Subjects in one Array , Marks in Another Array for each semester (1 D Array)
				//  Add above 2 Arrays in Another Array for each Semester (2 D Array)
				//  Add all above 5 semesters in another array (3 D Array)
