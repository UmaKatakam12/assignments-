...
public class RulesOFVariables {
	...
	public static void main(String[] args) {
		//Variable or Identifier Rules:
			...
			//1. The variable/Identifier should be meaningful
			int carNumber = 2233;
			
			//2. The variable/Identifier should starts with lower case when we are creating package, variable, method and it should starts with upper case when we are creating class
